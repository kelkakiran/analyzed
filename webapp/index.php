...
$adrss=$_POST['address'];
$file=$_POST['foo'];
$sql=$insertdata->insert($fname,$email,$contact,$gender,$education,$adrss,$file);
if($sql)
{
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="navbar-header">
        <a class="navbar-brand" rel="home" href="#">Web App</a>
...
<div class="container-fluid">
 ...
 <!--/left-->
  ...
  <tr>
    ...
    <td><input type="file" name="foo" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf, image/*"></td>
	
	<?php $docObj = new DocxConversion("docs/Resume.docx");
